...
protected:
	...
	virtual bool executeAttack(Map& map, MapObserver& mo, MapElementsToggler& meo, vector<CharacterElement*>& chrElems) = 0; //! Executes the attack phase of the turn
public:
	...
	bool executeTurn(Map& map, MapObserver& mo, MapElementsToggler& meo, vector<CharacterElement*>& chrElems); // Executes a game turn on the CharacterStrategy
